<template>
  <div>
    ...
    <div class="mt-5">
      <p class="fw-bolder fs-1 text-center green mb-0">Create a gig</p>
       ...
       <div class="card-body">
        ...
        <div class="card" id="basic_card_2">
          <div class="card-body">
            ...
            />
            <div class="form-group mx-3 mx-lg-5 mx-md-5 py-3">
              <label for="exampleFormControlInput7" class="fw-bold my-3"
                >Name</label
              >
              <input
                type="email"
        ...
        <div class="card" id="basic_card_3">
          <div class="card-body">
            ...
            />
            <div class="form-group mx-3 mx-lg-5 mx-md-5 py-3">
              <label for="exampleFormControlInput" class="fw-bold my-3"
                >Name</label
              >
              <input
                type="email"
